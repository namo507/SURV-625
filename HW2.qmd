...
Now doing a sqrt of the S^2_w will give sqrt(29009578070) = $170,321, which shows the average standard deviation across strata is about $170,321.
...
Humanities: 4 Social Sciences: 16 Natural Sciences: 21 Engineering: 25 Business: 35
...
n_h = allocated sample size for stratum h
N_h = population size for stratum h
S_h^2 = variance in stratum h
...
For Humanities (h=1):
$$(\frac{20}{570})^2 (1-\frac{4}{20})\frac{81,200^2}{4} = 1,623,500$$

For Social Sciences (h=2):
$$(\frac{90}{570})^2 (1-\frac{16}{90})\frac{101,700^2}{16} = 13,250,932$$

For Natural Sciences (h=3):
$$(\frac{120}{570})^2 (1-\frac{21}{120})\frac{130,900^2}{21} = 29,835,047$$

For Engineering (h=4):
$$(\frac{140}{570})^2 (1-\frac{25}{140})\frac{170,100^2}{25} = 57,351,500$$

For Business (h=5):
$$(\frac{200}{570})^2 (1-\frac{35}{200})\frac{216,400^2}{35} = 135,897,259$$
...
For Humanities (h=1):
$$(\frac{20}{570})^2 (1-\frac{2}{20})\frac{81,200^2}{2} = 3,652,875$$

For Social Sciences (h=2):
$$(\frac{90}{570})^2 (1-\frac{10}{90})\frac{101,700^2}{10} = 22,920,532$$

For Natural Sciences (h=3):
$$(\frac{120}{570})^2 (1-\frac{17}{120})\frac{130,900^2}{17} = 38,344,151$$

For Engineering (h=4):
$$(\frac{140}{570})^2 (1-\frac{25}{140})\frac{170,100^2}{25} = 57,351,500$$

For Business (h=5):
$$(\frac{200}{570})^2 (1-\frac{46}{200})\frac{216,400^2}{46} = 96,506,749$$
...
```
So looking at the results from my analysis of the cost-constrained stratified sampling design, I found that the sampling variance is approx 199,581,997 and the design effect is about 0.91. This design effect being less than 1 tells me that the stratified sampling approach, even with different costs per stratum, is more efficient than simple random sampling. Specifically, the design reduces the variance by about 9% compared to what we would get with simple random sampling. This shows that even when one has to work with budget constraints and varying costs across departments, one can still achieve better precision than a simple random sample would provide.