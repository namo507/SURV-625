...
Coefficient of variation: $$CV(x) = \frac{\sqrt{V(x)}}{x}$$
...
# Calculate variance of denominator
...
Variance under cluster sampling: $$V_{cluster}(\hat{p}) = \left(\frac{\sqrt{var_p_hat}}{total_x}\right)^2 = \left(\frac{\sqrt{11.73}}{184}\right)^2 = 0.00035$$
...
Coefficient of variation: $$CV(x) = \frac{\sqrt{V(x)}}{x} = \frac{\sqrt{8.5}}{184} = \frac{2.92}{184} = 0.016$$
...
# Calculate total denominator (x)
x <- sum(data$t_x)

# Calculate variance components for the denominator by stratum
